...
class DailyStock extends React.Component {
  ...
  componentDidMount = () => {
    ...
    db.collection("stocks")
      .doc("SHOP")
      .collection(this.handleDate(new Date()))
      .get()
      .then((qs) => {
        qs.forEach((doc) => {
  ...
  changeDate = (date) => {
    ...
    db.collection("stocks")
      .doc("SHOP")
      .collection(this.handleDate(date))
      .get()
      .then((qs) => {
        qs.forEach((doc) => {
  ...
  showReceive = (loc) => {
    ...
    if (this.state.displayData[loc]["empty"])
      comp = this.state.displayData[loc]["empty"]["er"].map((item) => {
        return (
          <tr>
            <td>{item.partyName}</td>
            <td>{item.erNumber}</td>
                  ...
                  <Tabs defaultActiveKey="location" id="uncontrolled">
                    <Tab eventKey="dispatch" title="Dispatch">
                      <table>
                        <thead>
                          <tr>
                            <th colSpan={3 + this.props.gas.length}>
                              Dispatch
                            </th>
                          </tr>
                          <tr>
                            ...
                            <th>Location</th>
                            <th colSpan={this.props.gas.length}>
                              Cylinder Quantity
                            </th>
                          </tr>
                          <tr>
                        ...
                        <tbody>{this.showDispatch("SHOP")}</tbody>
                      </table>
                    </Tab>
                    <Tab eventKey="receive" title="Receive">
                      <table>
                        ...
                        <tbody>{this.showReceive("SHOP")}</tbody>
                      </table>
                    </Tab>
                  </Tabs>
                  ...
                  <Tabs defaultActiveKey="location" id="uncontrolled">
                    <Tab eventKey="dispatch" title="Dispatch">
                      <table>
                        ...
                        <tbody>{this.showDispatch("CBJ")}</tbody>
                      </table>
                    </Tab>
                    <Tab eventKey="receive" title="Receive">
                      <table>
                        ...
                        <tbody>{this.showReceive("CBJ")}</tbody>
                      </table>
                    </Tab>
                  </Tabs>
                </Tab>
